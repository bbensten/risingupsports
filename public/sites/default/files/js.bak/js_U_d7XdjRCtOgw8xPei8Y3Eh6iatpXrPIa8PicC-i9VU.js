...
$('#zone-branding-wrapper .block-crew-dropdown .pane-custom a').live('mouseenter', function () {
  $('#zone-branding-wrapper .block-crew-dropdown .pane-views-panes').slideDown('fast');
});

$('#zone-branding-wrapper ..block-crew-dropdown').live('mouseleave', function () {
  $('#zone-branding-wrapper .block-crew-dropdown .pane-views-panes').slideUp('fast');
});
